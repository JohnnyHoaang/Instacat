...
az webapp config appsettings set --resource-group $RESOURCE_GROUP_NAME --name $APP_NAME --settings ATLAS_URI="mongodb+srv://kelsey:UVCsYZcgHAck7kN4@cluster0.cebsx9s.mongodb.net/?retryWrites=true&w=majority"
